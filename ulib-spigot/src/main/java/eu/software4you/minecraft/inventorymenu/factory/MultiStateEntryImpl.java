...
class MultiStateEntryImpl<T> extends EntryImpl implements MultiStateEntry<T> {
    private final Map<T, ItemStack> representations;
    private final Map<T, BiConsumer<Player, ClickType>> handlers;
    private T defaultState;
    private T currentState;

    MultiStateEntryImpl(T defaultState, ItemStack representation, Map<T, ItemStack> representations, Map<T, BiConsumer<Player, ClickType>> handlers, BiConsumer<Player, ClickType> defaultClickHandler, String clickPermission) {
