...
public class LazyValue<V> {
    ...
    /**
     * @param call the loading function
     */
    public LazyValue(final Callable<V> call) {
        this.call = call;
        set();
    }
     ...
     *
     * @return the value as specified by this object's {@link #LazyValue(Callable) loading task}.
     */
    @SneakyThrows
    public V get() {
