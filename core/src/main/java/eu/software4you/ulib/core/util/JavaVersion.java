 ...
 * (https://github.com/apache/commons-lang/blob/9f1ac974e1b52c58b1950acdaaf3e0d5881409df/NOTICE.txt)
...
public enum JavaVersion {
    ...
    private static float toFloatVersion(final String value) {
        ...
        if (toParse.length >= 2) {
            return Conversions.tryFloat(toParse[0] + '.' + toParse[1]).orElse(defaultReturnValue);
        }
