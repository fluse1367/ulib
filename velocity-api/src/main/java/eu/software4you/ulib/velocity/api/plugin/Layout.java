...
/**
 * Velocity variation of {@link eu.software4you.ulib.minecraft.api.plugin.Layout} with {@link Audience} as receiver.
 */
public interface Layout extends eu.software4you.ulib.minecraft.api.plugin.Layout<Audience>, ExtYamlSub {
