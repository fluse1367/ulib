...
/**
 * Spigot variation of {@link eu.software4you.ulib.minecraft.api.plugin.Layout} with {@link CommandSender} as receiver.
 */
public interface Layout extends eu.software4you.ulib.minecraft.api.plugin.Layout<CommandSender>, ExtYamlSub {
    @Override
