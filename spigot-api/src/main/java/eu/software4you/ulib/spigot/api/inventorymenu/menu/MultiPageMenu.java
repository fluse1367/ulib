package eu.software4you.ulib.spigot.api.inventorymenu.menu;
 ...
 *
 * @see eu.software4you.ulib.spigot.api.inventorymenu.builder.MultiPageMenuBuilder
 * @see eu.software4you.ulib.spigot.api.inventorymenu.builder.PageBuilder
 */
