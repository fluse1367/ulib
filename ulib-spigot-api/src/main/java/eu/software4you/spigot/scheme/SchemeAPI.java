...
public class SchemeAPI {
    ...
    public static void saveScheme(Scheme scheme, OutputStream out) throws IOException {
        out.write(("# Generated by Software4You.eu's uLib v" + ULib.get().getVersion() + ". You are not allowed to edit or remove this line! Software4you \u00a9"/* \u00a9 = © */ + new SimpleDateFormat("yyyy").format(new Date()) + "\n").getBytes());
