...
public enum ParticleEffect {
     ...
     * </ul>
     */
    EXPLOSION_NORMAL("explode", 0, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    EXPLOSION_LARGE("largeexplode", 1, null),
    /**
     * A particle effect which is displayed by exploding tnt and creepers:
     * <ul>
     ...
     * </ul>
     */
    EXPLOSION_HUGE("hugeexplosion", 2, null),
    /**
     ...
     * </ul>
     */
    FIREWORKS_SPARK("fireworksSpark", 3, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    WATER_BUBBLE("bubble", 4, null, ParticleProperty.DIRECTIONAL, ParticleProperty.REQUIRES_WATER),
    /**
     ...
     * </ul>
     */
    WATER_SPLASH("splash", 5, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    WATER_WAKE("wake", 6, Protocol.v1_7_R1, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SUSPENDED("suspended", 7, null, ParticleProperty.REQUIRES_WATER),
    /**
     ...
     * </ul>
     */
    SUSPENDED_DEPTH("depthSuspend", 8, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    CRIT("crit", 9, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    CRIT_MAGIC("magicCrit", 10, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SMOKE_NORMAL("smoke", 11, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SMOKE_LARGE("largesmoke", 12, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SPELL_INSTANT("instantSpell", 14, null),
    /**
     ...
     * </ul>
     */
    SPELL_MOB("mobSpell", 15, null, ParticleProperty.COLORABLE),
    /**
     ...
     * </ul>
     */
    SPELL_MOB_AMBIENT("mobSpellAmbient", 16, null, ParticleProperty.COLORABLE),
    /**
     ...
     * </ul>
     */
    SPELL_WITCH("witchMagic", 17, null),
    /**
     ...
     * </ul>
     */
    VILLAGER_ANGRY("angryVillager", 20, null),
    /**
     ...
     * </ul>
     */
    VILLAGER_HAPPY("happyVillager", 21, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    TOWN_AURA("townaura", 22, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    NOTE("note", 23, null, ParticleProperty.COLORABLE),
    /**
     ...
     * </ul>
     */
    PORTAL("portal", 24, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    ENCHANTMENT_TABLE("enchantmenttable", 25, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    FLAME("flame", 26, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    CLOUD("cloud", 29, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    REDSTONE("reddust", 30, null, ParticleProperty.COLORABLE),
    /**
     ...
     * </ul>
     */
    SNOW_SHOVEL("snowshovel", 32, null, ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    BARRIER("barrier", 35, Protocol.v1_8_R1),
    /**
     ...
     * </ul>
     */
    ITEM_CRACK("iconcrack", 36, null, ParticleProperty.DIRECTIONAL, ParticleProperty.REQUIRES_DATA),
    /**
     ...
     * </ul>
     */
    BLOCK_CRACK("blockcrack", 37, null, ParticleProperty.REQUIRES_DATA),
    /**
     ...
     * </ul>
     */
    BLOCK_DUST("blockdust", 38, Protocol.v1_7_R1, ParticleProperty.DIRECTIONAL, ParticleProperty.REQUIRES_DATA),
    /**
     ...
     * </ul>
     */
    WATER_DROP("droplet", 39, Protocol.v1_8_R1),
    /**
     * A particle effect which is currently unused:
     * <ul>
     ...
     * </ul>
     */
    ITEM_TAKE("take", 40, Protocol.v1_8_R1),
    /**
     ...
     * </ul>
     */
    MOB_APPEARANCE("mobappearance", 41, Protocol.v1_8_R1);
    ...
    private final Protocol requiredVersion;
     ...
     */
    ParticleEffect(String name, int id, Protocol requiredVersion, ParticleProperty... properties) {
        this.name = name;
        this.id = id;
    ...
    private static boolean isWater(Location location) {
        ...
        return material == Material.WATER || material == Material.valueOf(MultiversionManager.getVersion().below(Protocol.v1_13_R1) ? "STATIONARY_WATER" : "LEGACY_STATIONARY_WATER");
    }
     ...
     */
    public Protocol getRequiredVersion() {
    ...
    public boolean isSupported() {
        ...
        return ParticlePacket.getVersion().atLeast(requiredVersion);
    }
    ...
    public static final class ParticlePacket {
        private static Protocol version = MultiversionManager.getVersion();
         ...
         * @see #ParticleEffect(String, int, Protocol, ParticleProperty...) (ParticleEffect, float, float, float, float, int, boolean, ParticleData)
         */
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                if (version.atLeast(Protocol.v1_8_R1)) {
                    enumParticle = PackageType.MINECRAFT_SERVER.getClass("EnumParticle");
                }
                Class<?> packetClass = PackageType.MINECRAFT_SERVER.getClass(version.below(Protocol.v1_8_R1) ? "Packet63WorldParticles" : "PacketPlayOutWorldParticles");

                packetConstructor = BukkitReflectionUtils.getConstructor(packetClass);
                getHandle = BukkitReflectionUtils.getMethod("CraftPlayer", PackageType.CRAFTBUKKIT_ENTITY, "getHandle");
                playerConnection = BukkitReflectionUtils.getField("EntityPlayer", PackageType.MINECRAFT_SERVER, false, "playerConnection");
                sendPacket = BukkitReflectionUtils.getMethod(playerConnection.getType(), "sendPacket", PackageType.MINECRAFT_SERVER.getClass("Packet"));
        ...
        private void initializePacket(Location center) throws PacketInstantiationException {
            ...
            try {
                ...
                if (version.below(Protocol.v1_8_R1)) {
                    String name = effect.getName();
                    if (data != null) {
                        name += data.getPacketDataString();
                    }
                    BukkitReflectionUtils.setValue(packet, true, "a", name);
                } else {

                    BukkitReflectionUtils.setValue(packet, true, "a", enumParticle.getEnumConstants()[effect.getId()]);
                    BukkitReflectionUtils.setValue(packet, true, "j", longDistance);
                    if (data != null) {
                        int[] packetData = data.getPacketData();
                        BukkitReflectionUtils.setValue(packet, true, "k", effect == ParticleEffect.ITEM_CRACK ? packetData : new int[]{packetData[0] | (packetData[1] << 12)});
                    }
                }
                BukkitReflectionUtils.setValue(packet, true, "b", (float) center.getX());
                BukkitReflectionUtils.setValue(packet, true, "c", (float) center.getY());
                BukkitReflectionUtils.setValue(packet, true, "d", (float) center.getZ());
                BukkitReflectionUtils.setValue(packet, true, "e", offsetX);
                BukkitReflectionUtils.setValue(packet, true, "f", offsetY);
         ...
         *
         * @param center Center location of the effect
         * @param range  Range in which players will receive the packet (Maximum range for particles is usually 16, but it can isDiffer for some types)
